...
const apiUrl=process.env.API_URL??"http://127.0.0.1:4000/api",webUrl=process.env.WEB_URL??"http://127.0.0.1:3000";
...
function start(workspace){const child=spawn("npm",["run","dev","-w",workspace],{stdio:"inherit",env:process.env});children.push(child);return child}
