...
export const userData=()=>({name:faker.person.fullName(),email:`e2e-${Date.now()}-${faker.string.alphanumeric(6)}@example.com`.toLowerCase(),phone:"+92 300 1234567",password:`Lm!${faker.string.alphanumeric(12)}`});
